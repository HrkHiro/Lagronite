    ...
    <div className="mx-auto max-w-5xl text-white">
      <section className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/20 md:p-8">
        <div className="space-y-3">
          <p className="text-sm uppercase tracking-[0.24em] text-emerald-400">Student Module</p>
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">Report a Lost Item</h2>
        ...
        <form className="mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]" onSubmit={handleSubmit}>
          ...
          <aside className="space-y-5">
            ...
            <button
              ...
              className="w-full rounded-2xl bg-emerald-500 px-5 py-3 font-medium text-slate-950 transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-70"
            >
